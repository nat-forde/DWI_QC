...
`module load R/3.4.3`  
```
R -e "Sys.setenv(RSTUDIO_PANDOC='/mnt/tigrlab/quarantine/rstudio/1.1.414/build/rstudio-1.1.414/bin/pandoc'); 
rmarkdown::render('/path/to/script/Quant_QC_DWI.Rmd', output_file='/path/to/output/$STUDY_Quant_QCreport.html')" 
--args "/path/to/dmriprep/QC/$STUDY_eddy_metrics.csv"
```
